  ...
  return (
    <div className='w-full p-5 m-auto bg-custom-blue/20 pt-10'>
      <div className='flex flex-col justify-center items-center m-auto'>
        ...
        <p className='text-xs md:text-sm leading-6 my-5 text-center'>We would be happy to hear from you if you have any questions, or would just like to say hi. Please don't hesitate to contact us; we value your message.</p>
      </div>
